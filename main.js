...
async function init(){
    ...
    await fetch("https://github.com/CzechAirArline/PRIVATE-GEOFS-LiverySelector/blob/58bcc6dbe06436e9235b57002f563e3c2ea41857/livery.json").then(res => res.json()).then(data => liveryobj = data)
